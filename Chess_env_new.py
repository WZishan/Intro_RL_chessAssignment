...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 31 10:18:27 2022
...
class Chess_Env_new:
    ...
    def Initialise_game(self,new_feature_k1,new_feature_q1):
        ...
        if new_feature_k1:
            X=self.new_Features_k1()
        elif new_feature_q1:
            X=self.new_Features_q1()
        elif new_feature_k1 and new_feature_q1:
            X = self.new_Features()
    ...
    def OneStep(self,a_agent,new_reward,new_feature_k1,new_feature_q1):
        
        
        if new_reward == False:
            # SET REWARD TO ZERO IF GAME IS NOT ENDED
            R=0
        elif new_reward == True:
            R = -0.1
    ...
    def new_Features_q1(self):
        ...
        Q1dof=np.zeros([16])   # NUMBER OF ALLOWED ACTIONS FOR ENEMY'S KING, ONE-HOT ENCODED
        Q1dof[np.sum(self.dfq1_constrain).astype(int)]=1
        
        # ALL FEATURES...
        x = np.concatenate([s_k1, s_q1, s_k2, check, K2dof, Q1dof],0)
    ...
    def new_Features(self):
        ...
        # ALL FEATURES...
        x = np.concatenate([s_k1, s_q1, s_k2, check, K2dof, K1dof, Q1dof],0)
